          ...
          <div className="mt-8 space-y-6">
            ...
            <div className="bg-green-50 border border-green-200 rounded-lg p-4 flex gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-green-700 mt-1">{result.summary.totalProviders} provider{result.summary.totalProviders !== 1 ? 's' : ''} found • Max speed: {formatSpeed(result.summary.maxDownloadSpeed)}</p>
              </div>
            </div>
