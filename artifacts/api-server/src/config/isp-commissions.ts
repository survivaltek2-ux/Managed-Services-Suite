...
export const RESIDENTIAL_COMMISSIONS: Record<string, CommissionEntry> = {
  xfinity: {
    ...
    affiliateSignupUrl: "https://business.comcast.com/affiliates",
    affiliateUrl: null,
  ...
  att: {
    ...
    commissionType: "per_sale",
    network: "CJ Affiliate",
    affiliateSignupUrl: "https://www.att.com/business/partners",
    affiliateUrl: null,
  ...
  charter: {
    ...
    commissionType: "per_sale",
    network: "CJ Affiliate",
    affiliateSignupUrl: "https://www.charterpartners.com",
    affiliateUrl: null,
  ...
  verizon: {
    ...
    affiliateSignupUrl: "https://www.verizon.com/business/affiliate",
    affiliateUrl: null,
  ...
  frontier: {
    ...
    commissionType: "per_sale",
    network: "CJ Affiliate",
    affiliateSignupUrl: "https://www.frontier.com/affiliates",
    affiliateUrl: null,
...
export const VOIP_COMMISSIONS: Record<string, CommissionEntry> = {
  ...
  nextiva: {
    ...
    affiliateSignupUrl: "https://nextiva.com/partners",
    affiliateUrl: null,
    notes:
  ...
  grasshopper: {
    ...
    commissionType: "per_sale",
    network: "CJ Affiliate",
    affiliateSignupUrl: "https://grasshopper.com/affiliate-program",
    affiliateUrl: null,
    notes:
  ...
  ooma: {
    ...
    commissionType: "per_sale",
    network: "FlexOffers",
    affiliateSignupUrl: "https://www.ooma.com/business/affiliates",
    affiliateUrl: null,
    notes:
...
export const HOME_SECURITY_COMMISSIONS: Record<string, CommissionEntry> = {
  ...
  simplisafe: {
    ...
    commissionType: "per_sale",
    network: "Impact",
    affiliateSignupUrl: "https://www.simplisafe.com/partners",
  ...
  brinks: {
    ...
    commissionType: "per_sale",
    network: "CJ Affiliate",
    affiliateSignupUrl: "https://www.brinks.com/business/affiliates",
    affiliateUrl: null,
    notes:
...
export const CONSUMER_ANTIVIRUS_COMMISSIONS: Record<string, CommissionEntry> = {
  ...
  mcafee: {
    ...
    percentRate: "25%",
    network: "CJ Affiliate",
    affiliateSignupUrl: "https://www.mcafee.com/en-us/business/affiliate",
    affiliateUrl: null,
    notes:
  ...
  avast: {
    ...
    percentRate: "25–40%",
    network: "CJ Affiliate",
    affiliateSignupUrl: "https://www.avast.com/business/affiliate",
    affiliateUrl: null,
    notes:
  ...
  totalav: {
    ...
    affiliateSignupUrl: "https://www.totalav.com/affiliates",
    affiliateUrl: null,
    notes:
