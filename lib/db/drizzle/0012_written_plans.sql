...
DO $$ BEGIN
  ALTER TABLE "written_plans" ADD CONSTRAINT "written_plans_partner_id_fkey"
    FOREIGN KEY ("partner_id") REFERENCES "partners"("id") ON DELETE SET NULL;
EXCEPTION WHEN duplicate_object THEN NULL;
END $$;

DO $$ BEGIN
  ALTER TABLE "written_plans" ADD CONSTRAINT "written_plans_parent_plan_id_fkey"
    FOREIGN KEY ("parent_plan_id") REFERENCES "written_plans"("id") ON DELETE SET NULL;
EXCEPTION WHEN duplicate_object THEN NULL;
END $$;
